...
for (let i = 0; i < arr.length; i++) {
    ...
    <a href="singlepage.html">
        <div class="giantbox show-on-scroll">
            <div class="box1">
            <img src="${arr[i].src}" alt="Picture">
        </div>
        <div class="hide">
...
`
    showcase.insertAdjacentHTML('afterbegin', html)
};
...
//detail src ra 1 trang con 
//chức năng giỏ hàng mẫu là todo list
// deploy lên webhost000 hoặc git là
//favicon 
// chỉnh lại màu săsc cho hài hòa + banner đổi đi